...
Source0  : https://cpan.metacpan.org/authors/id/K/KI/KILINRAX/HTML-Strip-2.11.tar.gz
...
%prep
%setup -q -n HTML-Strip-2.11
cd %{_builddir}
tar xf %{_sourcedir}/libhtml-strip-perl_2.10-1.debian.tar.xz
cd %{_builddir}/HTML-Strip-2.11
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/HTML-Strip-2.11/deblicense/
